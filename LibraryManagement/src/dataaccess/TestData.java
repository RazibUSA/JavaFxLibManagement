...
public class TestData {
	...
	public List<Author> allAuthors = new ArrayList<Author>() {
		{
			add(new Author("Joe", "Thomas", "641-445-2123", addresses.get(0),"Phd", "A happy man is he."));
			add(new Author("Sandra", "Thomas", "641-445-2123", addresses.get(0),"Phd", "A happy wife is she."));
			add(new Author("Nirmal", "Pugh", "641-919-3223", addresses.get(1), "MS", "Thinker of thoughts."));
			add(new Author("Andrew", "Cleveland", "976-445-2232", addresses.get(2), "Dr.", "Author of childrens' books."));
			add(new Author("Sarah", "Connor", "123-422-2663", addresses.get(3), "Phd", "Known for her clever style."));
		}
	};
	
	@SuppressWarnings("serial")
	public List<LibraryMember> allMember = new ArrayList<LibraryMember>() {
		{
			add(new LibraryMember("001", "Joe", "Thomas", "641-445-2123", addresses.get(0)));
			add(new LibraryMember("002","Sandra", "Thomas", "641-445-2123", addresses.get(0)));
		}
	};
	...
	public void libraryMemberData() {
		DataAccessFacade.loadMemberMap(allMember);
	}	
